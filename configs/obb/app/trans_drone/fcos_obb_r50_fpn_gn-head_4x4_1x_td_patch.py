...
train_pipeline = [
    ...
    dict(type='RandomOBBRotate', rotate_after_flip=True,keep_shape=True,
         angles=(45, 90), vert_rate=0.5),
...
data = dict(
    ...
    workers_per_gpu=1,
    train=dict(
        ann_file=data_root + 'split_set_train/annfiles/patch_annfile.pkl',
        img_prefix=data_root + 'split_set_train/images/',    
        pipeline=train_pipeline),
    val=dict(
        ann_file=data_root + 'split_set_test/annfiles/patch_annfile.pkl',
...
lr_config = dict(
    ...
    step=[16, 22])
total_epochs = 24
work_dir = 'data/td/work_dirs/fcos_obb_r50_fpn_gn-head_4x4_1x_td_patch_rotate'