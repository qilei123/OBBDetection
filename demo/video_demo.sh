...
python demo/video_demo.py \
    configs/obb/app/trans_drone/fcos_obb_r50_fpn_gn-head_4x4_1x_td_patch.py \
    data/td/work_dirs/fcos_obb_r50_fpn_gn-head_4x4_1x_td_patch_rotate/latest.pth \
    --split BboxToolkit/tools/split_configs/trans_drone/aw_test.json \
    --video_dir "/home/qilei/DATASETS/trans_drone/trans_drone_videos/DJI_0601 Wide View 400.MOV" \
    --out_dir "/home/qilei/DATASETS/trans_drone/DJI_0601 Wide View 400_patch_rotate.MOV" --mix --save_imgs